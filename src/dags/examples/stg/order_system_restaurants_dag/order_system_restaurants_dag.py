...
from examples.stg.order_system_restaurants_dag.pg_saver_orders import PgSaverOrders
...
@dag(
    ...
    tags=['sprint5', 'mongo', 'stg'],  # Теги, используются для фильтрации в интерфейсе Airflow.
